...
public:
  ...
  class  FunctionTypeContext : public TypeNameContext {
  public:
    FunctionTypeContext(TypeNameContext *ctx);
  ...
  class  RegularTypeContext : public TypeNameContext {
  public:
    RegularTypeContext(TypeNameContext *ctx);
