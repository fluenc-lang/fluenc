...
#include "nodes/ArrayContinuation.h"
...
ArrayElement::ArrayElement(const Type *iteratorType, const Node *next)
	: m_iteratorType(iteratorType)
	, m_next(next)
{
}

std::vector<DzResult> ArrayElement::build(const EntryPoint &entryPoint, Stack values) const
{
	Stack valuesIfTrue;
