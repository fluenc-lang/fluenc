...
Binary::Binary(Node *consumer, const std::string &op)
	: m_consumer(consumer)
	, m_op(op)
{
}

std::vector<DzResult> Binary::build(const EntryPoint &entryPoint, Stack values) const
{
...
const TypedValue *Binary::resolveOp(const EntryPoint &entryPoint, const TypedValue *left, const TypedValue *right) const
{
