...
MemberAccess::MemberAccess(antlr4::ParserRuleContext *context, Node *consumer, const std::string &name)
	: m_context(context)
	, m_consumer(consumer)
	, m_name(name)
{
...
std::vector<DzResult> MemberAccess::build(const EntryPoint &entryPoint, Stack values) const
{
